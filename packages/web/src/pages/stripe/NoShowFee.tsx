    ...
    return (
      <div>
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h2 className="text-2xl font-bold text-charcoal dark:text-white mb-2">No-Show Fee Charged</h2>
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-bold text-charcoal dark:text-white">No-Show Fee</h1>
      </div>
        ...
        <Card className="bg-red-50/50 border-red-200">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-charcoal dark:text-white">No-Show Fee</p>
                <p className="text-sm text-warm-gray dark:text-gray-300">Flat rate charge</p>
              </div>
            </div>
            <span className="text-2xl font-bold text-charcoal dark:text-white">$30.00</span>
          </div>
          <Button
            className="w-full"
            size="lg"
