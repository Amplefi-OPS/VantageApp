...
export default function PatientProfile() {
  ...
  const billingAction = searchParams.get('action')
  ...
  // Billing modals — auto-open from query params (e.g. ?tab=billing&action=charge)
  const [showChargeModal, setShowChargeModal] = useState(billingAction === 'charge')
  const [showNoShowModal, setShowNoShowModal] = useState(billingAction === 'noshow')
  ...
  return (
    <div>
      ...
      <div className="mt-5">
        ...
        {tab === 'notes' && (
          <>
            {/* Notes (with audio player when available for dictated notes) */}
